...
template <int dim0, int dim1, int spacedim, typename Matrix>
void
dealii::NonMatching::assemble_nitsche_exact(
...
template void
dealii::NonMatching::assemble_nitsche_exact<2, 1, 2>(
...
template void
dealii::NonMatching::assemble_nitsche_exact<3, 2, 3>(
...
template void
dealii::NonMatching::assemble_nitsche_exact<3, 3, 3>(
  const DoFHandler<3, 3> &,
  const std::vector<
    std::tuple<typename dealii::Triangulation<3, 3>::cell_iterator,
