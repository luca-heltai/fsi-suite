...
namespace PDEs
{
  ...
  BaseProblem<dim, spacedim, LacType>::BaseProblem(
  ...
  template <int dim, int spacedim, class LacType>
  void
  BaseProblem<dim, spacedim, LacType>::setup_system()
  {
  ...
  template <int dim, int spacedim, class LacType>
  void
  BaseProblem<dim, spacedim, LacType>::assemble_system_one_cell(
  ...
  template <int dim, int spacedim, class LacType>
  void
  BaseProblem<dim, spacedim, LacType>::custom_estimator(
  ...
  template <int dim, int spacedim, class LacType>
  void
  BaseProblem<dim, spacedim, LacType>::copy_one_cell(const CopyData &copy)
  {
  ...
  template <int dim, int spacedim, class LacType>
  void
  BaseProblem<dim, spacedim, LacType>::assemble_system()
  {
  ...
  template <int dim, int spacedim, class LacType>
  void
  BaseProblem<dim, spacedim, LacType>::solve()
  {
    Assert(false, ExcPureFunctionCalled());
  }
  ...
  template <int dim, int spacedim, class LacType>
  void
  BaseProblem<dim, spacedim, LacType>::estimate(
  ...
  template <int dim, int spacedim, class LacType>
  void
  BaseProblem<dim, spacedim, LacType>::mark(const Vector<float> &error_per_cell)
  {
  ...
  template <int dim, int spacedim, class LacType>
  void
  BaseProblem<dim, spacedim, LacType>::refine()
  {
  ...
  template <int dim, int spacedim, class LacType>
  void
  BaseProblem<dim, spacedim, LacType>::output_results(
  ...
  template <int dim, int spacedim, class LacType>
  void
  BaseProblem<dim, spacedim, LacType>::print_system_info() const
  {
  ...
  template <int dim, int spacedim, class LacType>
  void
  BaseProblem<dim, spacedim, LacType>::run()
  {
  ...
  template <int dim, int spacedim, class LacType>
  void
  BaseProblem<dim, spacedim, LacType>::run_quasi_static()
  {
    print_system_info();
  ...
  template <int dim, int spacedim, class LacType>
  void
  BaseProblem<dim, spacedim, LacType>::setup_transient(ARKode &arkode)
  {
    arkode.output_step =
  ...
  template <int dim, int spacedim, class LacType>
  void
  BaseProblem<dim, spacedim, LacType>::run_transient()
  {
    print_system_info();
  ...
  template <int dim, int spacedim, class LacType>
  void
  BaseProblem<dim, spacedim, LacType>::run_steady_state()
  {
    print_system_info();
  ...
  template class BaseProblem<1, 1, LAC::LAdealii>;
  template class BaseProblem<1, 2, LAC::LAdealii>;
  template class BaseProblem<1, 3, LAC::LAdealii>;
  template class BaseProblem<2, 2, LAC::LAdealii>;
  template class BaseProblem<2, 3, LAC::LAdealii>;
  template class BaseProblem<3, 3, LAC::LAdealii>;

  template class BaseProblem<1, 1, LAC::LAPETSc>;
  template class BaseProblem<1, 2, LAC::LAPETSc>;
  template class BaseProblem<1, 3, LAC::LAPETSc>;
  template class BaseProblem<2, 2, LAC::LAPETSc>;
  template class BaseProblem<2, 3, LAC::LAPETSc>;
  template class BaseProblem<3, 3, LAC::LAPETSc>;

  template class BaseProblem<1, 1, LAC::LATrilinos>;
  template class BaseProblem<1, 2, LAC::LATrilinos>;
  template class BaseProblem<1, 3, LAC::LATrilinos>;
  template class BaseProblem<2, 2, LAC::LATrilinos>;
  template class BaseProblem<2, 3, LAC::LATrilinos>;
  template class BaseProblem<3, 3, LAC::LATrilinos>;
} // namespace PDEs
