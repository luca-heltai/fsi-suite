...
namespace PDEs
{
  namespace MPI
  {
    ...
    LinearProblem<dim, spacedim>::LinearProblem(
    ...
    template <int dim, int spacedim>
    void
    LinearProblem<dim, spacedim>::setup_system()
    {
      ...
      DoFTools::extract_locally_relevant_dofs(
        dof_handler, non_blocked_locally_relevant_dofs);
      ...
      block_solution.reinit(locally_owned_dofs, mpi_communicator);
      system_block_rhs.reinit(locally_owned_dofs, mpi_communicator);
    ...
    template <int dim, int spacedim>
    void
    LinearProblem<dim, spacedim>::assemble_system_one_cell(
    ...
    template <int dim, int spacedim>
    void
    LinearProblem<dim, spacedim>::copy_one_cell(const CopyData &copy)
    {
    ...
    template <int dim, int spacedim>
    void
    LinearProblem<dim, spacedim>::assemble_system()
    {
    ...
    template <int dim, int spacedim>
    void
    LinearProblem<dim, spacedim>::solve()
    {
      Assert(false, ExcPureFunctionCalled());
    }
    ...
    template <int dim, int spacedim>
    void
    LinearProblem<dim, spacedim>::estimate(Vector<float> &error_per_cell) const
    {
    ...
    template <int dim, int spacedim>
    void
    LinearProblem<dim, spacedim>::mark(const Vector<float> &error_per_cell)
    {
    ...
    template <int dim, int spacedim>
    void
    LinearProblem<dim, spacedim>::refine()
    {
    ...
    template <int dim, int spacedim>
    void
    LinearProblem<dim, spacedim>::output_results(const unsigned cycle) const
    {
    ...
    template <int dim, int spacedim>
    void
    LinearProblem<dim, spacedim>::print_system_info() const
    {
    ...
    // triangulation
    template class LinearProblem<2, 2>;
    template class LinearProblem<2, 3>;
    template class LinearProblem<3, 3>;
  } // namespace MPI
} // namespace PDEs
