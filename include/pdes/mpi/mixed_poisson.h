...
//
// ---------------------------------------------------------------------
#ifndef pdes_mpi_mixed_poisson_h
#define pdes_mpi_mixed_poisson_h
...
namespace PDEs
{
  namespace MPI
  {
    ...
    /**
     * Solve the MixedPoisson problem, in parallel.
     */
    template <int dim, int spacedim = dim>
    class MixedPoisson : public LinearProblem<dim, spacedim, LAC::LATrilinos>
    {
    public:
      /**
      ...
      /**
       * Destroy the MixedPoisson object
       */
      virtual ~MixedPoisson() = default;
    ...
    protected:
      /**
       * Explicitly assemble the MixedPoisson problem on a single cell.
       */
      virtual void
