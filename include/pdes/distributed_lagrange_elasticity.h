...
#ifndef pdes_distributed_lagrangeelasticity_h
#define pdes_distributed_lagrangeelasticity_h
...
namespace PDEs
{
  ...
  class DistributedLagrangeElasticity : public dealii::ParameterAcceptor
  {
  public:
  ...
  {
    template <int dim, int spacedim = dim>
    using DistributedLagrangeElasticity =
      PDEs::DistributedLagrangeElasticity<dim, spacedim, LAC::LAPETSc>;
  }
