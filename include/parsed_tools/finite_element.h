...
#ifndef parsed_tools_finite_element_h
#define parsed_tools_finite_element_h
...
namespace ParsedTools
{
  ...
  class FiniteElement : public dealii::ParameterAcceptor
  {
  public:
    /**
     ...
     */
    FiniteElement(const std::string &section_name    = "",
