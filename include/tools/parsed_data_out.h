#ifndef parsed_data_out_h
#define parsed_data_out_h
...
namespace Tools
{
  ...
  class ParsedDataOut : public dealii::ParameterAcceptor
  {
  public:
    /**
     * @brief Construct a new ParsedDataOut object
     *
     * @param name
     * @param base_name
     * @param output_format
     ...
     * @param comm
     */
    ParsedDataOut(const std::string & section_name             = "",
