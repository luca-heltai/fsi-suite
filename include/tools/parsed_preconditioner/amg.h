...
#ifndef parsed_amg_preconditioner_h
#define parsed_amg_preconditioner_h
...
namespace Tools
{
  ...
  public:
     ...
     */
    void
    set_constant_modes(const std::vector<std::vector<bool>> &constant_modes);
